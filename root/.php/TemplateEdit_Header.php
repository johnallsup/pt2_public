...
<a href="<?php echo $wiki->pagename;?>" target="_blank" class="action duplicate-edit block">E</a>
<a href="<?php echo $wiki->pagename.'?action=versions';?>" class="action versions block">&#9419;</a>
<a href="<?php echo $wiki->pagename;?>" target="_blank" class="action abort block">X</a>
<a href="<?php echo $wiki->pagename;?>" target="_blank" class="action show-preview block">P</a>
